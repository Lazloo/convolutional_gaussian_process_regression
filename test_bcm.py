...
obj_bcm = BayesianCommiteeMaschine.BayesianCommiteeMaschine()
...
y_mean_total, y_std_total = obj_bcm.prediction(x_test)
plot_gp(iFig=4, x=x_test, y_mean=y_mean_total, y_std=y_std_total,
        x_train=np.concatenate(obj_bcm.x_train), y_train=np.concatenate(obj_bcm.y_train))
y_mean_total, y_std_total = obj_bcm.prediction(x_test)
#
